...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_name', type=str, default='celebA_facenet_config2', help='experiment name for experiment directory', required = True)
    
    parser.add_argument('--config_file', type=str, default='config2.yaml', help='config file that has attack params', required = True)
